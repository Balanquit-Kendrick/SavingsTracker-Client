  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-4">
        ...
        <div className="bg-primary-foreground p-8 col-span-3 rounded-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-3 gap-4">
        <div className="bg-primary-foreground p-4 rounded-2xl lg:col-span-3 2xl:col-span-2">
          <LineChart />
        </div>
        <div className="bg-primary-foreground p-4 rounded-2xl lg:col-span-3 2xl:col-span-1">
          <MiniTable />
        </div>
      </div>
    </div>
